    ...
    <section class="container mt-3 mb-3 p-3 w-100">
      <div class="filtre-container bg-white p-3 border-3 w-100">
        <h3 class="ml-5">Filtre</h3>
          <form action="home?r=search" method="post" class="w-100">
              <div class="form-floating prix ">
                <input type="number" name="min" min="0" class="form-control" id="floatingPassword" placeholder="">
                <label for="floatingPassword">Prix minimum</label>
              </div>
              <div class="form-floating prix">
                <input type="number" name="max" class="form-control" id="floatingPassword" placeholder="">
