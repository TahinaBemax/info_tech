    ...
    <div class="container-fluid">
        ...
        <div class="offcanvas offcanvas-start bg-dark text-white" tabindex="-1" id="offcanvasExample"
            ...
            <div class="offcanvas-body left_offcanvas-body" id="">
                ...
                <hr>
                <ul class="list-menu">
                    <li><a href="index.jsp"> <i class="bi bi-house-door-fill me-3"></i> Home</a></li>
                    <li><a href="produits?r=liste"> <i class="bi bi-cart-fill me-3"></i> Produits</a></li>
                    <li><a href="commande?r=liste"> <i class="bi bi-card-checklist me-3"></i> Commandes</a></li>
                    <li><a href="client-servlet?r=liste"> <i class="bi bi-person-video me-3"></i></i> Clients</a></li>
                    <li><a href="detail-commande?r=liste"> <i class="bi bi-person-video me-3"></i></i> Detail commande</a></li>
                    <!-- <li class="dropdown">
                    ...
                    <hr>
                    <li><a href="/magasin/pages/login/login?r=log-out"><i class="bi bi-box-arrow-left me-3"></i> Log out</a></li>
                </ul>
            </div>
        </div>
    </div>
