...
public class Produit_s2 extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if (req.getParameter("r") != null && req.getParameter("r").equals("modif")) {
                ...
                // on supprime
                Produit produit = new Produit(0, null, null, 0, 0);
                produit.getById(id);
                req.setAttribute("produit", produit);
                req.getRequestDispatcher("index.jsp?page=edit-produit").forward(req, resp);
            } 
        } catch (Exception e) {
